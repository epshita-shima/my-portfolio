...
const Banner = () => {
    return (
        <div className='  mt-24 bg-gradient-to-r from-violet-500 to-fuchsia-400 '>
            <div div className='flex pt-24 pb-16 lg:container lg:mx-auto' >
                ...
                <div className='ml-14'>
                    <div>
                        ...
                        <h3 className='text-white text-2xl font-semibold mb-4'><span className='opacity-40 mr-6'>Age:</span>25</h3>
                        <h3 className='text-white text-2xl font-semibold mb-4'><span className='opacity-40 mr-6'>Phone:</span> +880 1757092331</h3>
                        <h3 className='text-white text-2xl font-semibold mb-4'><span className='opacity-40 mr-6'>Email:</span> epshitashima@gmail.com</h3>
                        <h3 className='text-white text-2xl font-semibold mb-8'><span className='opacity-40 mr-6 '>Address:</span> Mirpur-2, Dhaka-1216</h3>
                    </div>
                    <div className='mb-4'>
